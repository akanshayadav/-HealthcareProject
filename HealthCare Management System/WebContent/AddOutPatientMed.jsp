...
<title>Add Out Patient Medicine</title>
...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="AddOutPatientMed" method="post" >
     ...
     <div class="input-field col s6"  >
          ...
          <label for="first_name" >Drug Name</label>
           ...
           <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter Drug Quantity here" name="quant" style="color: white" min="0" max="2000"    id="first_name" type="number" class="validate" required>
          <label for="first_name" >Drug Quantity</label>
        </div>
     <div class="input-field col s6"  >
         
       
          <input Placeholder="Enter Date of Admission" name="adDate" style="color: white"  type="text" class="datepicker">
