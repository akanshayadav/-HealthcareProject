...
ArrayList<RegisterUserModel> ali1 =(ArrayList<RegisterUserModel>) session1.getAttribute("RegisterUserData");

for(RegisterUserModel rum:ali1 )
{
...
%>
          ...
          <tr>
            <td><%out.print(rum.getOpNo());%></td>
            <td><%out.print(rum.getName()); %></td>
            <td><%out.print(rum.getGender()); %></td>
             <td><%out.print(rum.getType()); %></td>
              <td><%out.print(rum.getBenificiary1()); %></td>
               <td><%out.print(rum.getBenificiary2()); %></td>
                <td><%out.print(rum.getAddress()); %></td>
                 <td><%out.print(rum.getAge()); %></td>
