...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="FindRegUser" method="post"  class="col s12">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter your Op No here" name="opno" min="0" max="6000" style="color: white"  id="password" type="number" class="validate" required>
