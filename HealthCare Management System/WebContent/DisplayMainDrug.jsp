...
<title>Display Main Base Drug</title>
...
">Home</a>
 ...
 <!-- Modal Structure modal 2 -->
  ...
  <ul id="slide-out" class="sidenav">
    ...
    <li><a href="operator.jsp"><i class="Large material-icons">local_hospital</i>Welcome Admin</a></li>
...
ArrayList<Main_Store> ali1 =(ArrayList<Main_Store>) session1.getAttribute("DrugMainData");
SimpleDateFormat sdf = new SimpleDateFormat("MM/dd/yyyy");
for(Main_Store rum:ali1 )
{
...
%>
          ...
          <tr>
            <td><%out.print(rum.getDrug_name());%></td>
            <td><%out.print(rum.getIn_store()); %></td>
            <td><%out.print(sdf.format(rum.getExpiry_Date_1())); %></td>
             <td><%out.print(sdf.format(rum.getExpiry_Date_2())); %></td>
