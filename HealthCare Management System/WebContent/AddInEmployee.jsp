...
<title>Add In Patient Employee</title>
...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="AddInEmployee" method="post" >

           <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter your Opno here" name="Opno" style="color: white" min="0" id="first_name" type="number" class="validate" required>
     ...
     <div class="input-field col s6"  >
          ...
          <label for="first_name" >Name</label>
           ...
           <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter your Age here" name="Age" style="color: white"  id="first_name" type="number" min="0" max="100" class="validate" required>
    ...
    <select name="gender" required>
      ...
      <option value="Female">Female</option>
        ...
        <div class="input-field col s6">
         ...
         <div class="input-field col s6">
          <input Placeholder="Enter Date of Discharge" name="disDate" style="color: white"  type="text" class="datepicker">
          <label  style="color: white">Date of Discharge</label>
        </div>
      </div>
    ...
    <div class="row">
      ...
      <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter Present Complaint" name="prcom" style="color: white" type="text" required>
          <label  style="color: white">Present Complaint</label>
        </div>
      </div>
      
            <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter Present History" name="prhis" style="color: white" type="text" required>
          <label  style="color: white">Present History</label>
        </div>
      </div>
            ...
            <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter Drug allergy" name="DrAl" style="color: white" type="text" required>
          <label  style="color: white">Drug allergy</label>
        </div>
      </div>   
       ...
       <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter  bedCharge" name="bedChrg" style="color: white" type="number" required>
          <label  style="color: white">Bed Charge</label>
        </div>
      </div>
       ...
       <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter XrayCharge" name="XrayChrg" style="color: white" type="number" required>
          <label  style="color: white">X-ray Charge</label>
        </div>
      </div>
