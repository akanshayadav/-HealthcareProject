...
<title>Search Out Patient Medicine</title>
...
<div class="row" style="padding-left: 33%;
    ...
    <form action="FindOutPatientMed" method="post"  class="col s12">
       

      <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter your Op No here" name="opno" style="color: white"  id="password" min="0" type="number" class="validate" required>
