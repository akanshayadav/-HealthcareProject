...
<title>Update Drug To Pharma Base</title>
...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="UpdatePharmaBasee" method="post"  class="col s12">
        ...
        <div class="input-field col s12">
          ...
          <label  style="color: white" >Drug Name</label>
             ...
             <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter the count of durgs" name="count" style="color: white"  min="0" type="number" class="validate" required>
