...
ArrayList<OperatorEntry> ali =(ArrayList<OperatorEntry>)session1.getAttribute("AllDataOutPatientMed");

for(OperatorEntry ips:ali )
{
...
%>
          ...
          <tr>
            ...
            <td><%out.print(ips.getDate()); %></td>
             <td><%out.print(ips.getNo_Of_Drugs()); %></td>
