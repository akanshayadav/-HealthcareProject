...
<title>Display All In Patient Student</title>
...
ArrayList<In_Patient_Student> ali1 =(ArrayList<In_Patient_Student>)session1.getAttribute("InPatientStudentData");

for(In_Patient_Student ips:ali1 )
{
              ...
              <td><%out.print(ips.getOccupation()); %></td>
               <td><%out.print(ips.getDate_of_admission()); %></td>
                ...
                <td><%out.print(ips.getDiagnosis()); %></td>
                 <td><%out.print(ips.getPresent_complaint()); %></td>
                 <td><%out.print(ips.getPatient_history()); %></td>
                 <td><%out.print(ips.getDrugs_allergy()); %></td>
