<%@page import="Model.In_Patient_Employee"%>
...
<title>Display In Patient Employee</title>
...
ArrayList<In_Patient_Employee> ali1 =(ArrayList<In_Patient_Employee>)session1.getAttribute("InPatientEmployeeData");

for(In_Patient_Employee ips:ali1 )
{
...
%>
          ...
          <tr>
            <td><%out.print(ips.getOpNo());%></td>
            <td><%out.print(ips.getName()); %></td>
            <td><%out.print(ips.getAge()); %></td>
             <td><%out.print(ips.getSex()); %></td>
              <td><%out.print(ips.getOccupation()); %></td>
               <td><%out.print(ips.getDate_of_admission()); %></td>
                <td><%out.print(ips.getDate_of_discharge()); %></td>
                <td><%out.print(ips.getDiagnosis()); %></td>
                 <td><%out.print(ips.getPresent_complaints()); %></td>
                 <td><%out.print(ips.getPatient_history()); %></td>
                 <td><%out.print(ips.getDrug_allergy()); %></td>
                   <td><%out.print(ips.getBed_charges()); %></td>
                     <td><%out.print(ips.getXray_charges()); %></td>
                            <td><%out.print(ips.getBilling()); %></td>
