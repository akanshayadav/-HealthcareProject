...
">Home</a>
 ...
 <!-- Modal Structure modal 2 -->
  ...
  <ul id="slide-out" class="sidenav">
    ...
    <li><a href="Admin.jsp"><i class="Large material-icons">local_hospital</i>Welcome Admin</a></li>
   
    <li><div class="divider"></div></li>
    <li><a class="subheader"><i class="Large material-icons">group</i>Services we provided</a></li>
    <br>
    <li><a href="register.jsp"><i class="Large material-icons">group_add</i>Register User</a></li>
    <li><a href="FindRegUser.jsp"><i class="Large material-icons">search</i>Find Register User</a></li>
   <li><a href="Display"><i class="Large material-icons">exposure</i>Display User</a></li>
...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="RegisterUser" method="post"  class="col s12">
      <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter your Name" name="name" style="color: white"  type="text" class="validate" required>
          <label style="color: white">Name</label>
        </div>
     <div class="input-field col s6"  >
          <input placeholder=" Date of birth" name="Age" min="1" max="100"  style="color: white"  type="number" class="validate"  required>
    ...
    <select  name="type" style="color: white"  class="validate" required>
      <option style="color: white !important" value="">Gender</option>
    ...
    <select  name="gender" style="color: white"  class="validate" required>
      <option style="color: white !important" value="">Type</option>
      <option style="color: white" value="Student">Student</option>
      <option style="color: white" value="Employee">Employee</option>
  ...
  <div class="row">
        <div class="input-field col s6"  >
          <input placeholder="Enter beneficiary 1" name="beneficiaryone" style="color: white"   type="text" class="validate" required>
          <label for="first_name" style="color: white">Beneficiary 1</label>
        </div>
         <div class="input-field col s6"  >
          <input placeholder="Enter beneficiary 2" name="beneficiarytwo" style="color: white"   type="text" class="validate" required>
          <label style="color: white">Beneficiary 2</label>
        </div>
      </div>     
      ...
      <div class="row">
        <div class="input-field col s12">
          <input Placeholder="Enter your address" name="address" style="color: white"  id="password" type="text" class="validate" required>
