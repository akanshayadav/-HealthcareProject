<%@page import="Model.NurseEntry"%>
<%@page import="Controller.FindOutPatientMed"%>
<%@page import="Model.OperatorEntry"%>
...
<title>Display Search Out Patient Medicine</title>
...
ArrayList<NurseEntry> ali =(ArrayList<NurseEntry>)session1.getAttribute("AllDataInPatientMed");

for(NurseEntry ips:ali )
{
...
%>
          ...
          <tr>
            ...
            <td><%out.print(ips.getDrug_Name()); %></td>
            <td><%out.print(ips.getMed_Given_date()); %></td>
             <td><%out.print(ips.getTime()); %></td>
             <td><%out.print(ips.getQuantity()); %></td>
