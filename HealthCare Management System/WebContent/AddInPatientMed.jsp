...
<title>Add In Patient Medicine</title>
...
<a class="waves-effect waves-light btn" href="Nurse.jsp" style="
    position: relative;
    left: -8%;
    top: -42px;
    background-color: #ee6e73;
">Home</a>
 ...
 <!-- Modal Structure modal 2 -->
  ...
  <ul id="slide-out" class="sidenav">
    ...
    <li><a href="Nurse.jsp"><i class="Large material-icons">local_hospital</i>Welcome Nurse</a></li>
   
    <li><div class="divider"></div></li>
    <li><a class="subheader"><i class="Large material-icons">group</i>Services we provided</a></li>
    <br>
  <li><a href="AddOutPatientMed.jsp"><i class="Large material-icons">library_add</i>Add OutPatient Medicine </a></li>
    <li><a href="SearchOutPatientMed.jsp"><i class="Large material-icons">update</i>Search OutPatient Medicine</a></li>
    <li><a href="DisplayOutPatientMed"><i class="Large material-icons">remove</i>Display OutPatient Medicin</a></li>
  
   <br>
      <li><a href="AddInPatientMed.jsp"><i class="Large material-icons">library_add</i>Add In-Patient Medicine</a></li>
 <li><a href="SearchInPatientMed.jsp"><i class="Large material-icons">update</i>Search In-Patient Medicine</a></li>
    <li><a href="DisplayInPatientMed"><i class="Large material-icons">remove</i>Display In-Patient Medicine</a></li>
...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="AddInPatientMed" method="post" >

           <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter your Opno here" name="Opno"  style="color: white"  id="first_name" min="0" type="number" class="validate" required>
          <label for="first_name" >Opno</label>
        </div>
     <div class="input-field col s6"  >
          <input placeholder=" Enter the Drug Name here" name="DrugName" style="color: white"  id="first_name" type="text" class="validate" required>
          <label for="first_name" >Drug Name</label>
           ...
           <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter Drug Quantity here" name="quant" style="color: white"  id="first_name" type="text" class="validate">
          <label for="first_name" >Drug Quantity</label>
        </div>
     <div class="input-field col s6"  >
         
       
          <input Placeholder="Enter Date of Admission" name="date" style="color: white"  type="text" class="datepicker">
          <label  style="color: white">Date of Admission</label>
                   ...
                   <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter time here" name="time" style="color: white"  id="first_name" type="text" class="timepicker">
