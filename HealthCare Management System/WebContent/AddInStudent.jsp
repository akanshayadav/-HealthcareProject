...
<title>Add In Patient Student</title>
...
<div class="row" style="padding-left: 33%;
    ...
    <div class="col s12 m5">
      <div class="card-panel teal" style="background-color: #ee6e73 !important">
         ...
         <div class="row">
    <form action="AddInStudent" method="post" >
     ...
     <div class="input-field col s6"  >
          ...
          <label for="first_name" >Name</label>
           ...
           <div class="row">
        <div class="input-field col s6"  >
          <input placeholder=" Enter your Age here" name="Age" style="color: white"  id="first_name" min="0" type="number" class="validate" required>
    ...
    <select name="gender">
      ...
      <option value="Female">Female</option>
             ...
             <div class="row">
        <div class="input-field col s6">
          <input Placeholder="Enter Date of Admission" name="adDate" style="color: white"  type="text" class="datepicker" required>
          <label  style="color: white">Date of Admission</label>
        </div>
         <div class="input-field col s6">
          <input Placeholder="Enter Date of Discharge" name="disDate" style="color: white"  type="text" class="datepicker" required>
